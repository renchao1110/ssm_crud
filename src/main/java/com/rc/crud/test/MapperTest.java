...
//		}
		...
		/*for(int i = 0;i<1000;i++){
			...
			mapper.insertSelective(new Employee(null,uid, uid+"@163.com", "M", 1));
		}
		System.out.println("批量完成");*/
		//Employee employee = mapper.selectByPrimaryKeywithDept(1);
		EmployeeExample e = new EmployeeExample();
		e.createCriteria().andEmailNotEqualTo("zs@163.com");

		List<Employee> employees = mapper.selectByExamplewithDept(e);
